...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"img/tiger.eps"}\NormalTok{, }\StringTok{"img/tiger.pdf"}\NormalTok{, }\StringTok{"img/tiger.png"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth,height=0.6\textheight]{beamer_files/figure-beamer/plot-example-1} 
...
\begin{center}\includegraphics[width=1\linewidth]{beamer_files/figure-beamer/plot-size-test1-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{beamer_files/figure-beamer/plot-size-test2-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth,height=0.7\textheight]{beamer_files/figure-beamer/punch-chart-example-1} 
...
{\centering \includegraphics[width=1\linewidth,height=0.6\textheight]{beamer_files/figure-beamer/venn-1} 
...
\begin{center}\includegraphics[width=0.4\linewidth]{beamer_files/figure-beamer/sushi-plot-1} \end{center}

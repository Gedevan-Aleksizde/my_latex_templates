...
mainfont: Hiragino Mincho ProN W3
sansfont: Hiragino Maru Gothic ProN W4
monofont: SF Mono
mainfont-ja: Hiragino Mincho ProN W3
sansfont-ja: Hiragino Maru Gothic ProN W4
monofont-ja: SF Mono
fontsize: 12pt
...
## 引用形式の変更
* デフォルトでは `[1]` のような番号形式
* 著者(年) 形式にしたい場合は, 以下の`[numbers]`を`[authoryear]`に
...
```{yaml citation-package, eval=F, echo=T}
